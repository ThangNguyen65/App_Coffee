        ...
        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
          ...
          return ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                ...
                final imageDetail_1 = data['imagedescribesmall1'] as String?;
                final imageDetail_2 = data['imagedescribesmall2'] as String?;
                final imageDetail_3 = data['imagedescribesmall3'] as String?;
                final imageDetail_4 = data['imagedescribesmall4'] as String?;
